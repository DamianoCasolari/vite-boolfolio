            ...
            <div class="container d-flex justify-content-between">
                ...
                <div class="logo_container d-flex">
                    ...
                    <!-- <a class="navbar-brand  media_none align-items-center justify-content-start mx-2 logo_filter lighter scale_hover"
                        href="https://wa.me/393331234567?text=MESSAGGIO" target="_blank">
                    ...
                    <!-- <router-link :to="{ 'name': 'contacts' }" >
                        <span class="navbar-brand  media_none align-items-center justify-content-start mx-2 logo_filter lighter scale_hover">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="60" fill="#212529"
                                viewBox="0 0 640 640">
                                <path
