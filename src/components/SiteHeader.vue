            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="logo_container d-none d-md-flex align-items-center">
                    <a class="navbar-brand align-items-center justify-content-start mx-0 logo_filter lighter scale_hover"
                        ...
                        target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="#212529" viewBox="0 0 640 640">
                    ...
                    <a class="navbar-brand d-flex align-items-center justify-content-start mx-2 logo_filter lighter scale_hover"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="40" fill="#212529" class="bi bi-linkedin lighter" viewBox="0 0 16 16">
                    ...
                    <button type="button" @click="toggleLang" title="Language"
                        ...
                        <svg v-if="!languageState.eng_lan" xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="#212529" viewBox="0 -960 960 960">
                        ...
                        <svg v-else xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="#212529" viewBox="0 -960 960 960">
