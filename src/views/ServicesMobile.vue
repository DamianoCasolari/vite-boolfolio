...
<template>
    <div class="mob_services" :class="{ entered, ready }">
        ...
        <Transition name="wa-btn">
            <a
                v-if="ctaVisible"
                href="https://wa.me/393477952189?text=Ciao%20Damiano!%20Vorrei%20usufruire%20della%20call%20gratuita%20che%20offri.%0AHo%20visto%20i%20tuoi%20servizi%20e%20mi%20piacerebbe%20parlare%20di%20un%20progetto%20a%20cui%20sto%20pensando."
                target="_blank"
...
.mob_wa_cta {
    ...
    &:hover { color: #fff; background: #20c05e; border-color: rgba(34,197,94,0.75); box-shadow: 0 16px 36px rgba(22,163,74,0.34), 0 0 0 4px rgba(34,197,94,0.13), inset 0 1px 0 rgba(255,255,255,0.35); }
}
