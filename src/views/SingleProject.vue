...
<template>
  ...
  <div
    v-else-if="project"
    class="single_project d-flex justify-content-center align-items-center"
  >
    <div class="container position-relative">
      <div
        class="main_info d-flex justify-content-between flex-wrap align-items-center"
      >
        <div class="wrap">
          <div
          ...
          >
            <button
              type="button"
              class="back_to_home text-decoration-none position-relative"
              @click="$router.back()"
              aria-label="Back"
      ...
      <div class="row">
        <!-- IMG SIDE -->
        <div
          class="cover_container col-12 col-md-5 py-3 px-3 h-100 position-relative"
        >
          <component
            ...
            target="_blank"
            rel="noopener"
            class="h-100 d-inline-block w-100 position-relative slide_up"
          >
            <div
              v-if="project.link"
            ...
            <img
              class="rounded-5 border-0 w-100 card_shadow max-height-60vh img-contain"
              :src="imageSrc"
              :alt="`${title} cover`"
              loading="eager"
              fetchpriority="high"
        ...
        <!-- INFO SIDE -->
        <div
          class="info_container col-12 col-md-7 py-3 px-3 slide_down position-relative"
        >
          <div
            class="card border border-0 rounded-5 w-100 h-100 overflow-hidden"
          >
            <div class="card-body h-100">
              <div class="h-100 overflow-auto">
                <p
                  class="description text_carbon h-100 position-relative fs-6 p-4"
                >
